...
chi = epsilon_r - 1; % Assuming uniform distribution where present
pitch = 200e-7;
ffactor = 0.1; % Filling Factors
k_plane = 0;
Nsearch = 8;
Nplot = 200;
N = 48;
search_re = linspace(70,130,61);
search_im = zeros(1,61);
search_re_width = ones(1,61);
search_im_width = 1.0*ones(1,61);
search_re_N = 200*ones(1,61);
search_im_N = 200*ones(1,61);
plot_my_band(chi,pitch,ffactor,k_plane,Nsearch,N,Nplot, ...
    1, search_re, search_im, search_re_width,search_im_width, ...
    search_re_N, search_im_N);